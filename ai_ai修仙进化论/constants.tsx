...
export const TOOLS_DATA: Tool[] = [
  {
    ...
    icon: './ai_ai修仙进化论/public/icons/feishu.png',
  ...
  },
  {
    ...
    // 已改为本地路径，请确保本地存在该文件
    icon: 'https://github.com/TFVC/xingyun/blob/master/ai_ai%E4%BF%AE%E4%BB%99%E8%BF%9B%E5%8C%96%E8%AE%BA/public/icons/deepseek.png?raw=true', 
    roles: [Role.PROJECT_MANAGER, Role.PRODUCT_MANAGER, Role.TECH_LEADER],
    tag: '大语言模型'
  },
  {
    ...
    // 已改为本地路径，请确保本地存在该文件
    icon: './ai_ai修仙进化论/public/icons/doubao.png',
    roles: [Role.PROJECT_MANAGER, Role.PRODUCT_MANAGER, Role.TECH_LEADER],
    tag: '智能助手'
  }
];
